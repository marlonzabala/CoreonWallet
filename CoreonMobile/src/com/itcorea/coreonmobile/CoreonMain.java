...
public class CoreonMain extends FragmentActivity implements OnClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		menu.setSecondaryShadowDrawable(R.drawable.left_shadow);
		...
		// coreon_main_info.xml
		// mPager = (ViewPager) findViewById(R.id.pager);
		// adapter = new MyPagerAdapter();
		// mPager.setAdapter(adapter);

		// add margin for viewpager
		// margin = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 60,
			...
			public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id)
			{
				switch (groupPosition)
				{
					...
					case 3:
						...
						{
							Toast.makeText(getApplicationContext(), "You are " + String.valueOf(dev) + " clicks away to becoming a developer",
		...
		Thread background = new Thread(new Runnable() {
			...
			public void run()
			{
				try
				{
					...
					adapter.addStrings("Coreon Points", points + " Points", "userinfo", 0, "userinfo",
							"usercontent");
					adapter.addStrings("", "", "", 0, "", "userline");
					...
					adapter.addStrings(
							...
							"August 25, 2013 at 11:30 PM", R.drawable.offer_image_2,
					...
					adapter.addStrings(
							...
							"August 25, 2013 at 11:30 PM", R.drawable.offer_image_2,
							"http://www.coreonmobile.com/", "textimage");
					adapter.addStrings("Dong Won Restaurant", "payment of Coreon Card",
							"August 25, 2013 at 11:30 PM", R.drawable.offer_image_1, "www.yahoo.com",
							"textimage");
																...
																public void onItemClick(AdapterView<?> parent, View view, final int position, long id)
																{
																	...
																	else if (position == 6)
																	{
																		...
																		adapter.addStrings("Dong Won Restaurant",
																				...
																				"August 25, 2013 at 11:30 PM", R.drawable.offer_image_1,
																				"www.google.com", "textimagenotice");
																		adapter.addStrings("Globe G-Cash",
																				"Lorem ipsum dolor sit amet, consectetur  adipiscin",
																				"August 25, 2013 at 11:30 PM", R.drawable.offer_image_2,
																				"www.google.com", "textimagenotice");
																		adapter.addStrings("Coreon Mobile",
																				"Discount Curabitur et justo egestas, tristique te",
																				"August 25, 2013 at 11:30 PM", R.drawable.offer_image_1,
																				"www.google.com", "textimagenotice");
																		adapter.addStrings(
																				"Dong Won Restaurant",
																					...
																					long id)
																			{
																				if (view.getTag().equals("textimagenotice"))
																				{
																					...
																					TextView textTitle = (TextView) view
																							.findViewById(R.id.lblSubTitleText);
																					TextView textDate = (TextView) view
																							.findViewById(R.id.lblDateText);
																					...
																					noticeContentAdapter.addStrings(textTitle.getText().toString(),
																							content, textDate.getText().toString(), imageInt, url,
																							"noticecontent");
																					noticeContentAdapter.addStrings("", "", "", 0, "", "space");
																	...
																	else if (view.getTag().equals("textimage"))
																	{
																		...
																		noticeContentAdapter.initiatizeStringsValues();
																		noticeContentAdapter.addStrings("space", "space", "space", 0, "space",
																				"space");
																	...
																	else if (view.getTag().equals("header"))
																	{
																		...
																		if (title.equals("Notice"))
																		{
																			// go to notices page
																			// open notices page
																			Toast.makeText(getApplicationContext(), "Notices", Toast.LENGTH_LONG)
																					.show();
																		}
																		else if (title.equals("Exclusive Offers"))
																		{
																			// go to offers page
																			// open offers page
																			Toast.makeText(getApplicationContext(), "Offers", Toast.LENGTH_LONG)
																					.show();
																		}
																	}
